...
@EnableSwagger2
/*
 * We are registering this DamcoAssessment micro service in configured eureka-discovery-server micro service in which we can see our all the registered micro services
