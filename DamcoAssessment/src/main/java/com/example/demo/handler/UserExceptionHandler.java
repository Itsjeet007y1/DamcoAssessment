...
public class UserExceptionHandler {
	...
	public ResponseEntity<ResponseDefObject<String>> duplicateUserFoundException(DuplicateUserFoundException exception) {
		return new ResponseEntity<ResponseDefObject<String>>(new ResponseDefObject<String> 
		(HttpStatus.CONFLICT.value(), Util.ERROR, exception.getMessage()), HttpStatus.CONFLICT);
	}
}
